...
export interface ApiCvCv extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    baseInfo: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiEducationEducation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::education.education'
    >;
    logo: Schema.Attribute.Media<'images' | 'videos'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    type: Schema.Attribute.Enumeration<['school', 'curse']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSocialLinkSocialLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['profile', 'channel', 'mail', 'group', 'phone']
    > &
      Schema.Attribute.Required &
